...
import 'package:brahminapp/calls/settings.dart';
...
class CallPage extends StatefulWidget {
  ...
  const CallPage({Key key, this.channelName, this.Userid, this.bid}) : super(key: key);
...
class _CallPageState extends State<CallPage> {
  ...
  Future<void> initialize() async {
    ...
    //_engine.joinChannel(null,'${widget.channelName}', null, 0);
  }
