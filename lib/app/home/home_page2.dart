      ...
      body: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshotT) {
            if (snapshotT.data == null) {
              ...
              if (snapshotT.data!.docs.isNotEmpty) {
                chanel = snapshotT.data!.docs[0].get("channel");
                callType = snapshotT.data!.docs[0].get("call_type");
                return Stack(
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(
                          top: 5, left: 4, right: 4, bottom: 0),
                      child: ListView(
                        children: [
                          SizedBox(
                            height: height(120),
                    ...
                    builder: (context) =>
                        Container(height: 300,
                          decoration: BoxDecoration(color: Colors.white,
                              borderRadius: BorderRadius.circular(10)),
                          child: TextButton(
                            child: Text("Join"), onPressed: () {},),));*/
                print("[THIS STATEMENT $chanel $callType]");
              }
              return Stack(
                children: [
                  Padding(
