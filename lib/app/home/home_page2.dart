import 'package:brahminapp/app/home/menu/panchang/panchang_section.dart';
import 'package:brahminapp/app/home/notice_board.dart';
...
class _HomePageFolderState extends State<HomePageFolder> {
  ...
  Widget build(BuildContext context) {
    ...
    List<dynamic> noticeBoardList = widget.snapshot!.data!.get("notice_board");
    noticeBoardList.sort((a, b) => (b["date"]).compareTo(a["date"]));
            ...
            child: ListView(
              children: [
                ...
                CarouselSlider.builder(
                    itemCount:
                        noticeBoardList.length > 4 ? 4 : noticeBoardList.length,
                      ...
                      children: [
                        ...
                        CustomGridTile(
                          ...
                          child: StreamBuilder<DocumentSnapshot>(
                              stream:
                                  FireStoreDatabase(uid: "null").getPanchang,
