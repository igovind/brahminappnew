...
class CustomFloatBoxPanel extends StatefulWidget {
...
class _FloatBoxState extends State<CustomFloatBoxPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    // All Buttons;
    List<Widget> _buttons = widget.buttons!;
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: _FloatButton(
                ...
                icon: widget.panelIcon ?? Icon(Icons.add),
