...
class NewSearchChoices<T> extends StatefulWidget {
  ...
  /// * [buildDropDownDialog] [Function] controls the layout of the dropdown dialog.
  /// * [searchInputDecoration] [InputDecoration] sets the search bar decoration.
  factory NewSearchChoices.single({
    Key? key,
  ...
  /// * [buildDropDownDialog] [Function] controls the layout of the dropdown dialog.
  /// * [searchInputDecoration] [InputDecoration] sets the search bar decoration.
  factory NewSearchChoices.multiple({
    Key? key,
    required List<DropdownMenuItem<T>> items,
    Function? onChanged,
  ...
  @override
  _NewSearchChoicesState<T> createState() => _NewSearchChoicesState();
}

class _NewSearchChoicesState<T> extends State<NewSearchChoices<T>> {
  ...
  @override
  void didUpdateWidget(NewSearchChoices oldWidget) {
    super.didUpdateWidget(oldWidget as NewSearchChoices<T>);
    updateSelectedItems();
  }
