...
import 'package:brahminapp/Chat/View/ChatPageView.dart';
...
class ChatListViewItem extends StatelessWidget {
  ...
  const ChatListViewItem({
    this.chatListModal,@required this.tuser}) ;
    ...
    return Slidable(
              ...
              Expanded(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    ...
                    FirebaseFirestore.instance.doc('messeges/${user.uid}/samvad/${chatListModal.id}').update({
                      'time':newFormat,
      ...
      secondaryActions: <Widget>[
        IconSlideAction(
          ...
          icon: Icons.delete,
          onTap: ()async{
            await FirebaseFirestore.instance.doc('/messeges/${user.uid}/samvad/${chatListModal.id}').delete();
          },
        )
      ],
    );
